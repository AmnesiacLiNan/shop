...
export function voucher(data) {
  return request.post('user/up/order/voucher',data);
}
 ...
 * 
*/
export function qrcoder(data) {
  return request.post('check/qrcoder', data);
}
...
export function detail(data) {
  return request.get('order/get/order/code/detail/'+data);
}